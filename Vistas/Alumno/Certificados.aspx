...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        .cert-card { transition: transform 0.2s; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="d-flex flex-column gap-2 mb-5">
        <h2 class="fw-bold text-body-emphasis mb-0">Mis Certificados</h2>
        <p class="text-muted">Tus logros académicos y diplomas obtenidos.</p>
    </div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4">
                    ...
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden cert-card">
                        ...
                        <div class="position-relative" style="height: 180px;">
                            ...
                            <div class="position-absolute top-50 start-50 translate-middle text-center w-100 px-3">
                                <div class="bg-warning  rounded-circle d-inline-flex align-items-center justify-content-center shadow mb-2" 
                                     style="width: 56px; height: 56px;">
                                    <i class="bi bi-trophy-fill fs-3"></i>
                                </div>
                                <h6 class=" fw-bold text-uppercase small mb-0" style="letter-spacing: 1px;">Certificado Oficial</h6>
                            </div>
                        </div>
        ...
        <asp:Panel ID="pnlVacio" runat="server" Visible="false" CssClass="col-12">
            <div class="text-center py-5">
                ...
                <a href="MisCursos.aspx" class="btn btn-outline-primary mt-2">Ir a Mis Cursos</a>
            </div>
        </asp:Panel>
