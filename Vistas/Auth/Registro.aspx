                ...
                <div class="card-body p-4 p-sm-5">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <button class="btn btn-outline-secondary" type="button" id="btnShowPassword"><i class="bi bi-eye"></i></button>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <button class="btn btn-outline-secondary" type="button" id="btnShowConfirmPassword"><i class="bi bi-eye"></i></button>
                        </div>
                    ...
                    <!-- Literal para inyectar script del modal -->
                    <asp:Literal runat="server" ID="litScriptModal" />
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        togglePassword('#btnShowPassword', '#<%= txtPasswordRegistro.ClientID %>');
        togglePassword('#btnShowConfirmPassword', '#<%= txtConfirmPassword.ClientID %>');
    });
</script>
    <script type="text/javascript">
